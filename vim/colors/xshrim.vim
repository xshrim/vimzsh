"https://themer.dev/
  ...
  let s:shade6 = "#b299db"
  let s:shade7 = "#c7aaf5"
  let s:accent0 = "#e869c9"
  let s:accent1 = "#9a7de4"
  let s:accent2 = "#c9581f"
  let s:accent3 = "#19c917"
  let s:accent4 = "#d433f0"
  let s:accent5 = "#f3cb1a"
  let s:accent6 = "#f530be"
  let s:accent7 = "#0ec0ec"
